...
for i in range(len(data)):
    ...
    for datum in data[i]["paraphrase"]:
        ...
        para_pre_ppl += datum["pre_ppl"]
        para_post_ppl += datum["post_ppl"]
    ...
    for datum in data[i]["generalization"]:
        ...
        pre_ppl = datum["pre_ppl"]
        post_ppl = datum["post_ppl"]
        gen_pre_ppl += datum["pre_ppl"]
        gen_post_ppl += datum["post_ppl"]
...
print('paraphrase:')
print('ppl delta:', para_ppl/para_cnt, 'pre ppl:', para_pre_ppl/para_cnt, 'post ppl:', para_post_ppl/para_cnt, 'pre acc:', para_pre_total/para_cnt_acc, 'post acc:', para_post_total/para_cnt_acc, 'consist ratio:', para_consist_cnt/para_consist_cnt_total)
print('generalization:')
print('ppl delta:', gen_ppl/gen_cnt, 'pre ppl:', gen_pre_ppl/gen_cnt, 'post ppl:', gen_post_ppl/gen_cnt, 'pre acc:', gen_pre_total/gen_cnt_acc, 'post acc:', gen_post_total/gen_cnt_acc, 'consist ratio:', gen_consist_cnt/gen_consist_cnt_total)