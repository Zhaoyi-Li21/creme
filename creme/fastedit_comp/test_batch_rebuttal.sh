...
for pat in 'suf'
do
    CUDA_VISIBLE_DEVICES=1 python comp_editor_batch.py \
        --data /root/autodl-tmp/zhaoyi/knowledge_locate/FastEdit/make_dataset/llama2_13b_$pat.json \
        --model /root/autodl-tmp/zhaoyi/huggingface_models/llama2-13b-hf \
        --config llama-7b \
        --template default
done
