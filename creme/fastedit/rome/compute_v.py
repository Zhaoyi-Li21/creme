...
def compute_v(
    ...
    # print(context_templates[0].format(request["prompt"]) + request["target"])
    # print(compl_tok)
    # print(prompt_tok)
    # print(tokenizer.tokenize(context_templates[0].format(request["prompt"]) + ' ' + request["target"]))
    # print(tokenizer.tokenize(request["target"]))
